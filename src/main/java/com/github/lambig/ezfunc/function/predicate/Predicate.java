...
public abstract class Predicate<E> extends Mapping<E, Boolean> {
  ...
  public static <E> Predicate<E> equalTo(final E target) {
  ...
  public static <E> Predicate<E> before(final int threshold) {
    return new Predicate<E>() {
      @Override
      public boolean eval(E current, int index) {
  ...
  public static <E> Predicate<E> after(final int threshold) {
    return new Predicate<E>() {
      @Override
      public boolean eval(E current, int index) {
        return index < threshold;
  ...
  public static <E> Predicate<E> between(int from, int to) {
    return
        Predicate.<E>and(
            Predicate.<E>after(from),
            Predicate.<E>before(to));
  }
